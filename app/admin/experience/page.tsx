...
//         body: JSON.stringify({ ...formData, courses: formData.courses.split(",").map((c) => c.trim()) }),
//       });
...
//         editingId ? prev.map((exp) => (exp._id === editingId ? updatedExperience : exp)) : [...prev, updatedExperience]
//       );
...
//       {editingId && (
//         <button
//           onClick={() => {setEditingId(null); setFormData({instituteName: "", startDate: { month: "", year: new Date().getFullYear() }, endDate: { month: "", year: new Date().getFullYear() }, courses: "", description: ""})}}
...
//         <h3 className="text-lg font-bold mb-2 text-black">{editingId ? "Edit Experience" : "Add New Experience"}</h3>
...
//           <input type="text" name="startMonth" placeholder="Start Month" value={formData.startDate.month} onChange={(e) => setFormData({ ...formData, startDate: { ...formData.startDate, month: e.target.value } })} className="w-1/2 p-2 mb-2 border rounded" required />
//           <input type="number" name="startYear" placeholder="Start Year" value={formData.startDate.year} onChange={(e) => setFormData({ ...formData, startDate: { ...formData.startDate, year: Number(e.target.value) } })} className="w-1/2 p-2 mb-2 border rounded" required />
//         </div>
//         <div className="flex space-x-2">
//           <input type="text" name="endMonth" placeholder="End Month" value={formData.endDate.month} onChange={(e) => setFormData({ ...formData, endDate: { ...formData.endDate, month: e.target.value } })} className="w-1/2 p-2 mb-2 border rounded" required />
//           <input type="number" name="endYear" placeholder="End Year" value={formData.endDate.year} onChange={(e) => setFormData({ ...formData, endDate: { ...formData.endDate, year: Number(e.target.value) } })} className="w-1/2 p-2 mb-2 border rounded" required />
//         </div>
