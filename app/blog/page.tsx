...
import SearchInput from "@/components/BlogSearch";
    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <motion.h2
          ...
          className="text-3xl font-bold mb-8 text-blue-950 text-center flex justify-center items-center"
        >
          Blogs
        </motion.h2>
        {/* <div className="fixed top-0 right-0"> */}
        <SearchInput setBlogs={setBlogs} />
        {/* </div> */}
        {/* </div> */}
