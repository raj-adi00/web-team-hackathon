...
import ProfessorHero from "./ProfessorHero/page";
...
export default function Home() {
  const professorData = {
    ...
    tagline: "Advancing the frontiers of quantum physics through research and education",
    image: "https://images.unsplash.com/photo-1573496799652-408c2ac9fe98?ixlib=rb-4.0.3",
